...
@Component({
  selector: 'app-madrid',
  templateUrl: './madrid.page.html',
  styleUrls: ['./madrid.page.scss'],
})
export class MadridPage implements OnInit{
  gamma: number=0;
  alpha: number=0;
  beta: number=0;
  ...
  constructor() { }newMap: any = null;
    async ngOnInit() {
        ...
        const mapRef: any = document.getElementById('map2');

        this.newMap = await GoogleMap.create({
            id: 'my-map2', // Unique identifier for this map instance
            ...
            zoom: 13.5, // The initial zoom level to be rendered by the map
            },
        });
